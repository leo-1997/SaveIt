...
public class AddressBookTest {
    ...
    public void resetData_withDuplicatePersons_throwsDuplicatePersonException() {
        ...
        AddressBookStub newData = new AddressBookStub(newIssues);
    ...
    /**
     * A stub ReadOnlyAddressBook whose issues list can violate interface constraints.
     */
    private static class AddressBookStub implements ReadOnlyAddressBook {
        private final ObservableList<Issue> issues = FXCollections.observableArrayList();

        AddressBookStub(Collection<Issue> issues) {
